...
export abstract class AIService {
  ...
  abstract analisarCompatibilidade(dadosCurriculo: any, dadosVaga: any, scoresSuporte?: any): Promise<DetalhesMatching & { score: number }>;
  abstract gerarPalavrasChave(dadosVaga: any): Promise<string[]>;
  abstract gerarResumoVaga(dadosVaga: any): Promise<string>;
  abstract otimizarCurriculo(dadosOriginais: any, descricaoVaga: string, feedbackMatching?: string): Promise<any>;
}
